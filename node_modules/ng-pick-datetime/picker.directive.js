...
var DateTimePickerDirective = (function () {
    function DateTimePickerDirective(vcRef, componentFactoryResolver, el) {
        ...
        this.dateTimePickerError = new core_1.EventEmitter(true);
    ...
    DateTimePickerDirective.prototype.openDialog = function () {
        if (!this.created) {
            ...
            cmpRef.instance.setDialog(this, this.el, this.dateTimePicker, this.autoClose, this.locale, this.viewFormat, this.returnObject, this.position, this.positionOffset, this.mode, this.hourTime, this.theme, this.pickerType, this.showSeconds, this.onlyCurrentMonth, this.minMoment, this.maxMoment);
...
DateTimePickerDirective.propDecorators = {
    ...
    'dateTimePickerError': [{ type: core_1.Output, args: ['dateTimePickerError',] },],
