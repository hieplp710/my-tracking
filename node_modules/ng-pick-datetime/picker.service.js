...
var PickerService = (function () {
    function PickerService() {
        this.selectedMomentSource = new BehaviorSubject_1.BehaviorSubject(null);
    ...
    PickerService.prototype.setPickerOptions = function (dtAutoClose, dtLocale, dtViewFormat, dtReturnObject, dtPosition, dtPositionOffset, dtMode, dtHourTime, dtTheme, dtPickerType, dtShowSeconds, dtOnlyCurrentMonth, dtMinMoment, dtMaxMoment) {
