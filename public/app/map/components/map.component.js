System.register(["@angular/core", "../../services/TrackingService", "@agm/core", "jquery", "./widgets/popup-device/popup.component", "angular2-cookie/core", "./widgets/roadmap-info/roadmap_info.component"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, TrackingService_1, core_2, jquery_1, popup_component_1, core_3, roadmap_info_component_1, MapComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            MapComponent = (function () {
                function MapComponent(trackingService, _mapsAPILoader, _cookie) {
                ...
                MapComponent.prototype.ngOnInit = function () {
                    ...
                    setTimeout(function () {
                        ...
                        document.addEventListener('visibilitychange', function () {
                            ...
                            if (document.hidden || _this.isRoadmap || _this.isReportView) {
                                ...
                                if (jquery_1.default('#play-roadmap-mobile > i')[0] !== undefined
                                    && jquery_1.default('#play-roadmap-mobile > i').attr('class').indexOf('fa-pause') !== -1) {
                    ...
                    jquery_1.default('#btnLogout').on('click', function (e) {
                        e.preventDefault();
                ...
                MapComponent.prototype.displayRoapmap = function (context) {
                    ...
                    var _loop_1 = function (i) {
                        ...
                        if (i !== (context.roadmapMarkers.length - 2) && (lt.status === 'Dừng' || lt.status === 'Đỗ')) {
                            ...
                            var distance = 0;
                            if (beginMarker !== lt) {
                                beginCood = new google.maps.LatLng({ "lat": beginMarker.lat, "lng": beginMarker.lng });
                                currentCood = new google.maps.LatLng({ "lat": lt.lat, "lng": lt.lng });
                                if (google.maps.geometry !== undefined) {
                                    distance = google.maps.geometry.spherical.computeDistanceBetween(beginCood, currentCood);
                                }
                            }
                            var nextLoc = context.roadmapMarkers[i + 1] !== undefined ? context.roadmapMarkers[i + 1] : null;
                ...
                MapComponent.prototype.getTotalRoadmapKm = function (roadmapMarkers) {
                    var km = 0;
                    if (roadmapMarkers.length <= 1) {
                        return 0;
                    }
                    ;
                    var startPoint = roadmapMarkers[0];
                    for (var i = 1; i < roadmapMarkers.length; i++) {
                        var tempMarker = roadmapMarkers[i];
                        var coord = new google.maps.LatLng({ "lat": tempMarker.lat, "lng": tempMarker.lng });
                        var locA = new google.maps.LatLng({ "lat": startPoint.lat, "lng": startPoint.lng });
                        if (google.maps.geometry !== undefined) {
                        ...
                        if (_this_1.isRunningRoadmap) {
                            ...
                            this.interPlayRoadmap = setInterval(function () {
                                ...
                                if (_this_1.roadmapMarkers != null && _this_1.roadmapMarkers[_this_1.playRoadmapIndex] !== undefined
                                    ...
                                    var km = 0;
                                    var strKm = '';
                                    if (_this_1.startPointRoadmap) {
                                        var locA = new google.maps.LatLng({ "lat": _this_1.startPointRoadmap.lat, "lng": _this_1.startPointRoadmap.lng });
                                        km = google.maps.geometry.spherical.computeDistanceBetween(locA, coord);
                                        strKm = (km / 1000).toFixed(1);
                                    }
                                    _this_1.startPointRoadmap = tempMarker;
                                    //_this.totalKmRoadmap += (km / 1000);
                                    if (_this_1.totalKmRoadmap === 0) {
                                        _this_1.totalKmRoadmap = _this_1.getTotalRoadmapKm(_this_1.allMarkerRoadmap);
                                    }
                                    var info = {
                                        km: strKm,
                                        kmph: tempMarker.velocity,
                                        time: tempMarker.time,
                                        totalKm: _this_1.totalKmRoadmap.toFixed(1)
                                    };
                                    _this_1.roadmapInfo.showInfo(info);
                                }
                                else {
                                    clearInterval(_this_1.interPlayRoadmap);
                                    ...
                                    jquery_1.default('#play-roadmap-mobile > i').removeClass('fa-pause').addClass('fa-play');
                                    _this_1.isRunningRoadmap = false;
                                    _this_1.startPointRoadmap = null;
                                    //_this.totalKmRoadmap = 0;
                                    return false;
                                }
                ...
                ], MapComponent.prototype, "devicePopup", void 0);
                __decorate([
                    core_1.ViewChild('roadmapInfo'),
                    __metadata("design:type", roadmap_info_component_1.RoadmapInfoComponent)
                ], MapComponent.prototype, "roadmapInfo", void 0);
                MapComponent = __decorate([
                    ...
                    __metadata("design:paramtypes", [TrackingService_1.TrackingService, core_2.MapsAPILoader, core_3.CookieService])
                ], MapComponent);
                return MapComponent;
            }());
